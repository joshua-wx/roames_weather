...
sd_l              = 3;   %sd decorrelation length (km)
...
sd_stat_rng       = 1;   %rng from target aws to search for sd point (km)
%add paths
addpath('../../lib/m_lib')
addpath('../../etc')
mkdir('tmp')
...
%load date list generated by AWS filter (on top of radar mesh filter)
