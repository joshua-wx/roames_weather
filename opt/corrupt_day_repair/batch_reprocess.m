...
rapic_list_fn = 'restore_rapic_fflist.mat';
load(rapic_list_fn)
...
%     %init temp dir
%     daily_path = [tempdir,'rapic_daily/'];
%     clear_dir(daily_path)
     tilt_path  = [tempdir,'rapic_tilt/'];
%     clear_dir(tilt_path)
     vol_path = [tempdir,'rapic_vol/'];
%     clear_dir(vol_path)
%     
...
%         file_cp(restore_ffn_list{day_idx(j)},local_daily_ffn,0,1);
%     end
