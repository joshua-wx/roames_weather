...
%ftp primary machine
%ec2_ip      = '13.54.40.153';
%[sout,eout] = unix(['scp -i /home/meso/aws_key/JoshPlayKey.pem ', tar_fn ,' fedora@',ec2_ip,':~/prep_bomradar'])
...
delete('/home/meso/dev/roames_weather/prep_bomradar/etc/global.config')
delete('/home/meso/dev/roames_weather/prep_bomradar/etc/site_info.txt')