...
copyfile('/home/meso/dev/wv/etc/site_info_hide.txt',etc_path)
...
delete('/home/meso/dev/wv/wv_kml/etc/global.config')
delete('/home/meso/dev/wv/wv_kml/etc/site_info.txt')
delete('/home/meso/dev/wv/wv_kml/etc/site_info_hide.txt')