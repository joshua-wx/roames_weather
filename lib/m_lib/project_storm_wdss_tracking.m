function [proj_lat,proj_lon,proj_azi,search_dist,track_length]=project_storm_wdss_tracking(tn1_init_ind,tn1_ident_ind,tn_dt,proj_min_track_len,mode_scan_freq,storm_db)
