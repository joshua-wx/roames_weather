function [radar_azi_grid,radar_elv_grid,radar_rng_grid] = preallocate_transform(radar_lat,radar_lon,radar_alt,radar_lat_vec,radar_lon_vec,radar_alt_vec,earth_rad,ke)
...
%create radar grid
[radar_lon_grid,radar_lat_grid,radar_alt_grid] = meshgrid(radar_lon_vec,radar_lat_vec,radar_alt_vec);
...
%radar azimuth grid
radar_azi_grid    = azimuth(radar_lat,radar_lon,radar_lat_grid,radar_lon_grid);
%real(asin(sin((pi/2)-deg2rad(radar_lat_grid)).*sin(deg2rad(radar_lon_grid-radar_lon))./sin(radar_gcdist_grid./earth_rad)));
