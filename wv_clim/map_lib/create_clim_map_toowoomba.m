...
ax=axesm('mercator','MapLatLimit',[-28 -27.2],'MapLonLimit',[151.9 152.6]);
...
%mlabel on; plabel on;
framem on; axis off;
%setm(ax, 'MLabelLocation', .2, 'PLabelLocation', .2,'MLabelRound',-1,'PLabelRound',-1,'LabelUnits','degrees','Fontsize',10)
...
%geoshow(topo_z,topo_refvec,'DisplayType','contour','LevelList',[500:200:1200],'LineColor','k','LineWidth',2);
